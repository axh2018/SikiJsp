...
live2d_settings['homePageUrl']          = '{127.0.0.1:8080}';       // 主页地址，可选 'auto'(自动), '{URL 网址}'
live2d_settings['homePageUrl']          = 'index.jsp';       // 主页地址，可选 'auto'(自动), '{URL 网址}'
live2d_settings['aboutPageUrl']         = 'https://github.com/axh2018';   // 关于页地址, '{URL 网址}'
